  ...
  display: {
    ...
    medium: {
      ...
      desktop: {
        ...
        fontWeight: FONT_WEIGHT_TOKENS.extraBold,
        letterSpacing: 'var(--typography-display-medium-desktop-letter-spacing)',
      },
    },
    // Display Small
    small: {
  ...
  headline: {
    ...
    large: {
      ...
      desktop: {
        ...
        fontWeight: FONT_WEIGHT_TOKENS.bold,
        letterSpacing: 'var(--typography-headline-large-desktop-letter-spacing)',
      },
    },
    // Headline Medium
    medium: {
      mobile: {
        ...
        fontWeight: FONT_WEIGHT_TOKENS.bold,
        letterSpacing: 'var(--typography-headline-medium-mobile-letter-spacing)',
      },
      desktop: {
        fontSize: 'var(--typography-headline-medium-desktop-size)',
        lineHeight: 'var(--typography-headline-medium-desktop-line-height)',
        fontWeight: FONT_WEIGHT_TOKENS.bold,
        letterSpacing: 'var(--typography-headline-medium-desktop-letter-spacing)',
      },
    },
    // Headline Small
    small: {
      ...
      desktop: {
        ...
        fontWeight: FONT_WEIGHT_TOKENS.bold,
        letterSpacing: 'var(--typography-headline-small-desktop-letter-spacing)',
      },
    },
  },
...
export type TypographyScale = 'display' | 'headline' | 'title' | 'body' | 'label';
 ...
 * @returns 현재 디바이스 타입
 */
export const getCurrentDevice = (breakpoint: number = 768): TypographyDevice => {
